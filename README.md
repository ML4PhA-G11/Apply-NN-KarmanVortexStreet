...
1. train the network by running ```python run-all-tensorflow.py``` this should result in a keras model being saved. (refer to the repo: https://github.com/ML4PhA-G11/model-experiments )
